...
function getNumberFromString(s) {
  s = parseFloat(s); // Використовуємо функцію parseFloat для того, щоб спробувати отримати число з рядка
  if (isNaN(s)) {
...
function getIntegerFromString(s) {
  ...
  return isNaN(number)
    ...
    : number; // Використовуємо функцію parseInt для того, щоб спробувати отримати ціле число з рядка
  // Перевіряємо, чи є отримане значення числом за допомогою isNaN
...
function encodeURLComponent(urlComponent) {
  ...
  return encodedComponent; // Ця функція повертає закодований компонент URL, замінивши небезпечні символи на їх процентне кодування.
...
function encodeURL(url) {
  ...
  return URI; // Використовуємо вбудовану функцію encodeURI, щоб закодувати введений URL.
...
function decodeURLComponent(urlComponent) {
  const decodeComponent = decodeURIComponent(urlComponent);
  return decodeComponent; // Використовуємо вбудовану функцію decodeURIComponent, щоб декодувати введений закодований компонент URL.
...
function decodeURL(url) {
  ...
  return URL; // Використовуємо вбудовану функцію decodeURI, щоб декодувати введений закодований URL.
